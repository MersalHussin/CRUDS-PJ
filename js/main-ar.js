    ...
    function showDate(){
        ...
        <tr>
                        ...
                        <td><button onclick ="updateDate(${i}),getTotal()">تحديث المنتج</button></td>
                        <td><button onclick="deleteDate(${i})">مسح المنتج</button></td>
                    </tr>
        `;
        }
        ...
        if(dataPro.length > 0){
            btnDelete.innerHTML =  `<button "id" = "delete" onclick = "confirmDelete()"> مسح الكل (${dataPro.length})</button>`
        }else{
            btnDelete.innerHTML = ""
        }
    }
    ...
    function confirmDelete() {
        // عرض مربع الحوار
        const confirmation = confirm("هل أنت متأكد من رغبتك في حذف الكل؟");
    ...
    function updateDate(i){
        ...
        submit.innerHTML = "تحديث بيانات المنتج"
        mood = "update"
    ...
    function getSearchMood(id){
        ...
        if(id === "searchTitle"){
            searchMood = "title"
            search.placeholder = `أبحث بواسطةالعنوان`
        }else{
            searchMood = "category"
            search.placeholder = `أبحث بواسطةالصنف`
        }
    search.focus()
    search.value = ""
    showDate()
